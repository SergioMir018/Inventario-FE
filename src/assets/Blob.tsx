...
export default function Blob() {
  ...
  return (
    <svg id="visual" className='blur z-0 relative opacity-50 drop-shadow-lg group-hover:drop-shadow-neon group-hover:opacity-100 h-[250px] max-w-screen sm:h-[600px] sm:w-[700px] md:h-[600px] md:w-[800px] lg:w-[900px] lg:h-[600px]' viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg"
      version="1.1">
