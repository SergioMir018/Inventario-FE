...
export default function Blob() {
  ...
  return (
    <svg id="visual" className='blur -z-10 -translate-y-[15vh] w-[550px] h-[450px] sm:h-[600px] sm:w-[700px] md:h-[600px] md:w-[800px] lg:w-[900px] lg:h-[600px]' viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg"
      version="1.1">
