  ...
  return (
    <section className='text-white font-gabarito mx-28 mt-12 h-full mb-auto'>
      <div className='flex flex-col w-full'>
        <h1 className='font-gabarito-bold text-5xl mb-5'>
          Tu carrito de la compra
        </h1>
        <p className='font-gabarito text-white/60 ml-1'>
          Revisa y actualiza el contenido de tu carrito antes de realizar la
          orden
        </p>
      </div>
